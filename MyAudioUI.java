	...
	public static void main(String[] args)
	{
		...
		while (scanner.hasNextLine())
		{
			...
			else if (action.equalsIgnoreCase("BOOKTOC")) 
			{
				...
				int i = scanner.nextInt();
				if (!(mylibrary.printAudioBookTOC(i)))
					System.out.println(mylibrary.getErrorMessage());
			...
			else if (action.equalsIgnoreCase("PLAYBOOK")) 
			{
				...
				if (!(mylibrary.playAudioBook(i, chap)))
					System.out.println(mylibrary.getErrorMessage());
			}
			...
			else if (action.equalsIgnoreCase("PLAYPL")) 
			{
				...
				if (!(mylibrary.playPlaylist(title, i)))
					System.out.println(mylibrary.getErrorMessage());
			}
		  ...
		  // see class Library for the method to call
			else if (action.equalsIgnoreCase("ADDTOPL")) 
			{
				...
				int i = scanner.nextInt();
				if (!(mylibrary.addContentToPlaylist(type, i, title)))
					System.out.println(mylibrary.getErrorMessage());
			}
		  ...
		  // see class Library for the method to call
			else if (action.equalsIgnoreCase("DELFROMPL")) 
			{
				...
				int i = scanner.nextInt();
				if (!(mylibrary.delContentFromPlaylist(i, title)))
					System.out.println(mylibrary.getErrorMessage());
			}
