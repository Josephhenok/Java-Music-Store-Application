...
public class AudioBook extends AudioContent
{
									...
									String author, String narrator, ArrayList<String> chapterTitles, ArrayList<String> chapters)
	{
		...
		//initializes all the instance variables of the class
	}
  ...
  // Print information about the audiobook. First print the basic information of the AudioContent 
	...
	public void printInfo()
	{
		...
		System.out.println("Author: " + this.author + " Narrrated by: " + this.narrator); //prints and concatenates information about the audiobook
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	public void play()
	{
		super.setAudioFile(chapterTitles.get(currentChapter) + ".\n" + chapters.get(currentChapter));//Sets the audio file to the current chapter's title and content suing the setAudioFile() method of the superclass
		super.play();// Calls the play() method of the superclass
	...
	public void printTOC()
	{
		for (int i = 0; i < chapters.size(); i++){
			...
			// Prints the chapter number, title, and a newline character for formatting for each index of the chapters arraylist
		}
	...
	{
		if (chapter >= 1 && chapter <= chapters.size())//Checks if the chapter number is valid and within the bounds of the ArrayList
		{
			currentChapter = chapter - 1;//Sets currentChapter to the chapter's index in the ArrayList
		}
	}
	...
	public boolean equals(Object other)
	{
		...
		if (super.equals(OtherAudiobook) && this.author.equals(OtherAudiobook.author) && this.narrator.equals(OtherAudiobook.narrator)){ //Checks if the superclass equals() method returns true and if the author and narrator are equal
			return true;
		}
		return false;
