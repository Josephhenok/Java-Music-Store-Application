...
public class Song extends AudioContent // implement the Comparable interface
{
	...
	public void play()
	{
		...
		super.play();
		System.out.println("");
		//sets audiofile to lyrics then uses the play() method of the superclass to play it then creates a new line
		}
	...
	public boolean equals(Object other)
	{
		...
		if (super.equals(OtherSong) && this.composer.equals(OtherSong.composer) && this.artist.equals(OtherSong.artist)){
			return true;
			//checks if composer and artist are equal using an object of the song class
		}
		return false;
